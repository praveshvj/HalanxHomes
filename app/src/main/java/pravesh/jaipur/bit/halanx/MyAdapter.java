...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView==null){
            convertView=View.inflate(context,R.layout.single_item,null);
        }

        ImageView imageView=convertView.findViewById(R.id.myimage);
        TextView textView=convertView.findViewById(R.id.rent);
        TextView textView2=convertView.findViewById(R.id.bhk);
        TextView textView3=convertView.findViewById(R.id.accomo);
        ...
        textView2.setText(singleItem.getBhk_count()+"BHK");
        textView3.setText(singleItem.getRadius()+" km from here");
